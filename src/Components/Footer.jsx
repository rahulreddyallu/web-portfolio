      ...
      <div className="footer-container">
        ...
        <div className="footer-top">
          ...
          <div className="footer-brand">
            <h3 className="footer-logo">Rahul Reddy Allu</h3>
            <p className="footer-tagline">
              Business Analyst & Developer crafting innovative solutions 
              for enterprise SaaS and FinTech.
            </p>
          ...
          <div className="footer-section">
            ...
            <div className="footer-contact">
              <a href="mailto:rahul@example.com" className="footer-link">
                rahul@example.com
              </a>
